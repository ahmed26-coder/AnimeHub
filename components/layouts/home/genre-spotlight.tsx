        ...
        {genres.map((genre) => {
          ...
          return (
            <Link key={genre.id} href={`/anime?genre=${genre.id}`} className="h-full bg-black/10 rounded-xl ">
              <Card
                className={`group p-0 relative flex flex-col h-full rounded-xl border-2 border-transparent overflow-hidden
            transition-all duration-300 ease-in-out
            bg-gradient-to-br ${genre.bgColor || 'from-blue-900/80 to-purple-900/80 dark:from-blue-950/90 dark:to-popover-950/90'}
            hover:shadow-xl hover:border-primary/40 hover:scale-[1.02]
            dark:bg-gradient-to-br dark:from-blue-900 dark:hover:to-popover-900
